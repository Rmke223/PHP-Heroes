...
INSERT INTO heroes (name, about_me, biography) VALUES ('Mental Marvin', 'His name may be ordinary, but his powers are not!', 'Once a famous medical researcher, Mental Marvin performed an experimental procedure on himself - with unexpected results. His full mental potential was unlocked, giving him powers over the physical world and the minds of those around him.');
